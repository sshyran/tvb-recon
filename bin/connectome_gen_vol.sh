...
#Label:
python -c "import bnm.recon.algo.reconutils; bnm.recon.algo.reconutils.label_vol_from_tdi('./tdi_ends-v$VOX.nii.gz','./tdi_lbl-v$VOX.nii.gz')"
...
python -c "import bnm.recon.algo.reconutils; bnm.recon.algo.reconutils.remove_zero_connectivity_nodes('./tdi_lbl-v$VOX.nii.gz','./vol-counts$STRMLNS_SIFT_NO-v$VOX.csv',tract_length_path='./vol-mean_tract_lengths$STRMLNS_SIFT_NO-v$VOX.csv')"
