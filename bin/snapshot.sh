...
if [ $# -gt 0 ]; then
    ...
    if [ "$1" == "use_freeview" ]; then
        ...
        case "$2" in
		    ...
		    "surf_annot" )
                refreshSnapshotNumber
                python bnm.recon.qc.image.freeview.py surface_annotation
