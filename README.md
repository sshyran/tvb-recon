...
- pegasus
	...
	<br> The <i>config</i> folder also contains the configuration files which are patient specific. These are the only files that will change for each run and/or patient. The possible configurations are explained in a later section.
- provision
