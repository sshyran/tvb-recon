...
do
    for h in lh rh
    do
        python -c "import tvb.recon.algo.reconutils; tvb.recon.algo.reconutils.subparc_files('$SUBJECTS_DIR/$SUBJECT/surf/$h.sphere',
                                '$SUBJECTS_DIR/$SUBJECT/label/$h.aparc.annot','$SUBJECTS_DIR/$SUBJECT/label/$h.aparc.sub$area',$area)"
